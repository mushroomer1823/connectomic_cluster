...
for i = 274:-1:247
    for j = 1:length(List)
        ...
        for u = 1:num
            ...
            warp = fullfile(dataPath,List{j}(1:6),'proc','Yeo','mrtrix_warp_corrected_for_track_Atlas2Sub.mif');
    ...
    for j = 1:length(List)
        ...
        for u = 1:num
            ...
            warp = fullfile(dataPath,List{j}(1:6),'proc','Yeo','mrtrix_warp_corrected_for_track_Sub2Atlas.mif');
            commandline = ['/home/wuye/Software/miniconda3/bin/tcktransform ',filename,' ',warp,' ',filename2,' -force -quiet'];
            system(commandline);
        end
    end
