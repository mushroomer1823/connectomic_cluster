...
for i = length(nodes):-1:1
    for j = 1:length(List)
        disp(List{j})
        subPath = fullfile(Path,List{j},'Parcels_7Networks',strcat(num2str(nodes(i,2)),'_',num2str(nodes(i,3))),'cluster_in_yeo_space');
        outPath = fullfile(Path,List{j},'Parcels_7Networks',strcat(num2str(nodes(i,2)),'_',num2str(nodes(i,3))),'Cluster');
        mkdir(outPath);
        ...
        for u = 1:num
            ...
            filename2 = fullfile(outPath,'temp2.tck');
    ...
    for j = 1:length(List)
        subPath = fullfile(Path,List{j},'Parcels_7Networks',strcat(num2str(nodes(i,2)),'_',num2str(nodes(i,3))),'Cluster');
        outPath = fullfile(Path,List{j},'Parcels_7Networks',strcat(num2str(nodes(i,2)),'_',num2str(nodes(i,3))),'Cluster_clean_in_yeo_space');
        mkdir(outPath);
    ...
    subPath = fullfile(Path,List{1},'Parcels_7Networks',strcat(num2str(nodes(i,2)),'_',num2str(nodes(i,3))),'Cluster_clean_in_yeo_space');
    outPath = fullfile(Path,'Population_7Networks',strcat(num2str(nodes(i,2)),'_',num2str(nodes(i,3))),'Cluster_clean_in_yeo_space');
    mkdir(outPath);
    ...
    for u = 1:num
        filename = fullfile(Path,'*','7T','*','Parcels_7Networks',strcat(num2str(nodes(i,2)),'_',num2str(nodes(i,3))),'Cluster_clean_in_yeo_space',temp(u).name);
        filename2 = fullfile(outPath,'temp2.tck');
        ...
        delete(fullfile(outPath,'temp2.tck'));
    end
end
