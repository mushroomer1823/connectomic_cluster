...
for i = 1:length(nodes)
    ...
    for j = 1:length(List)
        ...
        for u = 1:num
            ...
            warp = fullfile(dataPath,strrep(List{i},'7T','3T'),'proc','Yeo','mrtrix_warp_corrected_for_track_Sub2Atlas.mif');
    ...
    outPath = fullfile(Path,'Population',strcat(num2str(nodes(i,2)),'_',num2str(nodes(i,3))),'Cluster_clean_in_yeo_space');
    mkdir(outPath);
